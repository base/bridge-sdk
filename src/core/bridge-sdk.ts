...
import {
  BaseEngine,
  type BaseBridgeCallOpts,
  type BaseBridgeTokenOpts,
} from "./base-engine";
...
export class BridgeSDK {
  ...
  async bridgeTokenFromBase(opts: BaseBridgeTokenOpts): Promise<Hash> {
    return await this.baseEngine.bridgeToken(opts);
  }
